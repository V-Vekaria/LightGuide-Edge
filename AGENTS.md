...
| P5 Edge Impulse | EI project public, model trained, INT8 quantised, library exported | 4 Aug | ✅ **done 7 Aug** — public link verified live 8 Aug (no login): https://studio.edgeimpulse.com/public/1082649/live · `Vish_Vekzz / LightGuide-Edge`, project 1082649. Like-for-like with the sklearn pipeline (195 train / 104 test windows both sides). INT8 TFLM model exists and is measured, closing the CW1 promise. **No library exported by design** — the tree beat it by 20 pp so it was not deployed, and `reports/edge_impulse_results.md` argues that as a result rather than an omission |
...
| P8 Deck + video | 12-min deck built, split-screen demo video cut | 7 Aug | 🟡 **unblocked 8 Aug** — P1, P5 and P7 have all produced their numbers. Deck due with Code on 9 Aug 12:00; video has its own submission link and is being cut 9 Aug |
